...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.redirect(new URL('https://haddock-special-presently.ngrok-free.app/connect/instagram?success=true', request.url))

  } catch (err) {
    console.error('Error in Instagram callback:', err)
    return NextResponse.redirect(new URL('https://haddock-special-presently.ngrok-free.app/connect/instagram?error=unknown', request.url))
  }
}